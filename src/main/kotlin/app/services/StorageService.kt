...
class StorageService(
    ...
    private val baseDir: File = File(System.getProperty("user.dir"), "src/main/resources")
) {
    private val filePath = File(baseDir, fileName).absolutePath
    ...
    fun loadTasks(): MutableList<Task> {
        ...
        if (!file.exists()) {
            println("Tasks file does not exist.")
